...
const WorkoutCard: React.FC<WorkoutCardProps> = ({ workout }) => {
  ...
  return (
    <div className="mb-4 rounded-xl overflow-hidden glass-card animate-scale-in">
      {/* Workout header - improved mobile responsiveness */}
      <div 
      ...
      >
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2 mb-1">
            <h3 className="font-semibold text-lg truncate flex-grow">{workout.title}</h3>
            <span 
              className="workout-tag flex items-center text-xs py-1 px-2 rounded-full shrink-0"
              style={{ 
